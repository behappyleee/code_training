...
public class BackJoon_4949 {
	...
	private final static int START_NUMBER = 666;
	
	public static void main(String[] args) throws IOException {
//		문제
//		666은 종말을 나타내는 숫자라고 한다. 따라서, 많은 블록버스터 영화에서는 666이 들어간 제목을 많이 사용한다. 
//		영화감독 숌은 세상의 종말 이라는 시리즈 영화의 감독이다. 조지 루카스는 
//		스타워즈를 만들 때, 스타워즈 1, 스타워즈 2, 스타워즈 3, 스타워즈 4, 스타워즈 5, 스타워즈 6과 같이 이름을 지었고, 
...
//		첫째 줄에 N번째 영화의 제목에 들어간 수를 출력한다.
		...
		int test = ((num - 1) * 1000) + START_NUMBER;
